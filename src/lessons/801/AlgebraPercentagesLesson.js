      ...
      <section className="mb-12">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
            ...
            <p className="mt-2"><strong>ארגון הנתונים בטבלה:</strong></p>            <DataTable
              title="ארגון הנתונים בטבלה:"
              headers={['תיאור', 'מחיר מקורי (ש"ח)', 'אחוז השינוי', 'סכום השינוי (ש"ח)', 'מחיר חדש (ש"ח)']}
              data={[
                ['מחיר המוצר', '200 (זה ה-100%)', '+15% (התייקרות)', '?', '?']
              ]}
            />
            ...
            <p className="text-center my-4">
              ...
              <span className="text-lg mr-2">ש״ח</span>
            </p>            <p>נשלים את הטבלה:</p>
            <DataTable
              data={[
                ['מחיר המוצר', '200', '+15%', '30', '230']
              ]}
            />
          ...
          <div className="border border-gray-200 rounded-lg p-4 bg-gray-50 mt-4">
            ...
            <p className="mt-2"><strong>ארגון בטבלה:</strong></p>            <DataTable
              title="ארגון בטבלה:"
              headers={['תיאור', 'מחיר מקורי (ש"ח)', 'אחוז השינוי', 'סכום השינוי (ש"ח)', 'מחיר חדש (ש"ח)']}
              data={[
                ['מחיר מכנסיים', '300', '-20% (הוזלה)', '?', '?']
              ]}
            />
