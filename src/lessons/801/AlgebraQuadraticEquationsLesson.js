...
const AlgebraQuadraticEquationsLesson = () => {
    ...
    },
    {
      ...
      solution: (
        <div>
          ...
          <p>זוהי משוואה חסרה (ללא מקדם x). נפתור על ידי בידוד:</p>          <FormulaBox>3x^2 = 12</FormulaBox>
  ...
  return (
    ...
    >
      ...
      {/* Practice Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-purple-600 mb-4 border-b-2 border-purple-200 pb-2">מתרגלים ✍️</h2>        <div className="space-y-6">
      ...
      {/* Quiz Section */}
      <section className="mb-12">        <h2 className="text-2xl font-semibold text-purple-600 mb-4 border-b-2 border-purple-200 pb-2">בוחן ידע 🧪</h2>
