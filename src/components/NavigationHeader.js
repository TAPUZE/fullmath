      ...
      <div className="container mx-auto px-4 sm:px-6 py-3">
        <div className="flex justify-between items-center">          {/* Logo and Brand */}
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link 
              to="/menu" 
              className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 hover:text-green-600 hover:bg-green-50 rounded-md transition-colors duration-150"
              title="מעבר לתפריט השיעורים"
            >
              <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
